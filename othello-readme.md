 ...
 * Implemented in Java and use Maven to build
 * Production quality code (e.g. simple, tested, pleasant to read, good names, no duplication ...)
 * No time limit but should take ~3 hours to complete
...
### Part 1
Provide a method that takes a csv String of moves and returns the resulting board as a String 
